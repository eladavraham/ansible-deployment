...
- deploy_platform_services.yaml - (re)deploys services considered platform - i.e rabbitmq, influxdb, elasticsearch
- deploy_gaia_services.yaml - (re)deploys main gaia services (also kibana and grafana)
